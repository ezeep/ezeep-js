...
| **trigger**     | *button*: renders a print button that opens the print dialog upon clicking it<br />*custom*: renders no element, but allows create a custom element or trigger to open the print dialog<br />*file*: renders a an area to allow drag and drop of a file | string  | Yes                                      |
| **fileurl**         | A url pointing to a file that should be printed. E.g. https://your-site.com/myfile.pdf                                                                                                                    | string  | Required, if trigger is set to *button* or *custom*.  |
