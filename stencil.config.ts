...
export const config: Config = {
  ...
  outputTargets: [
    angularOutputTarget({
      ...
      directivesProxyFile: 'dist/ezeep-js-angular/src/index.ts', // output file that gets generated by the outputTarget
    }),
    reactOutputTarget({
      componentCorePackage: '@ezeep/ezeep-js',
      proxiesFile: 'dist/ezeep-js-react/src/index.ts',
    }),
    {
      type: 'dist',
