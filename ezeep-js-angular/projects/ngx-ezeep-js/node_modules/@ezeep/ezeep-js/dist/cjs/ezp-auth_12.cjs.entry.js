...
const index = require('./index-1bd7b002.js');
...
const EzpAuth = class {
  constructor(hostRef) {
    ...
    this.authCancel = index.createEvent(this, "authCancel", 7);
    this.printShow = index.createEvent(this, "printShow", 7);
  ...
  render() {
    return this.hidelogin ? (index.h("ezp-progress", { status: i18next.t('login_page.login') })) : (index.h(index.Host, null, index.h("div", { id: "dialog" }, index.h("div", { id: "header" }, index.h("ezp-icon-button", { onClick: this.handleCancel, icon: "cross", level: "tertiary" })), index.h("div", { id: "content" }, index.h("ezp-icon", { id: "icon", name: "rocket", size: "large" }), index.h("ezp-label", { level: "primary", weight: "heavy", text: i18next.t('login_page.get_started') }), index.h("ezp-label", { text: i18next.t('login_page.description') }), index.h("ezp-text-button", { label: i18next.t('login_page.login'), id: "button", onClick: () => {
        this.openSignInWindow(this.auth.authURI.toString(), 'ezeep Login');
      } })))));
  }
};
...
const EzpBackdrop = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.backdropHideStart = index.createEvent(this, "backdropHideStart", 7);
    this.backdropHideEnd = index.createEvent(this, "backdropHideEnd", 7);
    this.visible = true;
  }
  handleClick() {
    this.visible = false;
  ...
  render() {
    return index.h(index.Host, { class: { hide: !this.visible }, onClick: () => this.handleClick() });
  }
...
const EzpIcon = class {
   ...
   */
  async componentWillLoad() {
    await fetch(index.getAssetPath(`./assets/glyph-${this.name}.svg`))
   ...
   */
  render() {
    return (index.h(index.Host, { class: this.size }, index.h("div", { id: "glyph", innerHTML: this.glyph })));
  }
...
const EzpIconButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: `${this.level}` }, index.h(TagType, Object.assign({ id: "button" }, attributes), index.h("ezp-icon", { name: this.icon }))));
  }
};
...
const EzpLabel = class {
   ...
   */
  render() {
    return (index.h(index.Host, { class: `${this.level} ${this.weight} ${this.ellipsis ? 'ellipsis' : ''} ${this.noWrap ? 'no-wrap' : ''}` }, index.h("div", { id: "text" }, this.text)));
  }
};
...
const EzpPrinterSelection = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.printCancel = index.createEvent(this, "printCancel", 7);
   ...
   */
  render() {
    return this.loading ? (index.h("ezp-progress", { status: i18next.t('printer_selection.loading') })) : (index.h(index.Host, { exportparts: "test: hello" }, this.printInProgress ? (index.h("ezp-progress", { status: i18next.t('printer_selection.print_in_progress') })) : null, index.h("div", { id: "container", "data-backdrop-surface": true }, index.h("div", { id: "header" }, index.h("ezp-label", { weight: "heavy", text: i18next.t('printer_selection.print') + ':' }), index.h("ezp-label", { text: this.filename }), index.h("ezp-icon-button", { level: "tertiary", icon: "menu", id: "toggle-menu", type: "button", onClick: this.handleUserMenu })), index.h("div", { id: "content" }, index.h("div", { id: "printer" }, index.h("ezp-select", { label: i18next.t('printer_selection.printer'), icon: "printer", placeholder: i18next.t('printer_selection.select_printer'), toggleFlow: "vertical", optionFlow: "vertical", options: this.printers.map((printer) => ({
        id: printer.id,
        title: printer.name,
        meta: printer.location,
        type: 'printer',
      })), preSelected: this.selectedPrinter.name })), index.h("div", { id: "options" }, index.h("ezp-select", { label: i18next.t('printer_selection.color'), placeholder: i18next.t('printer_selection.select_color'), toggleFlow: "horizontal", options: this.printerConfig.Color
        ? [
          {
            id: 1,
        ...
        ], preSelected: this.previouslySelectedProperties.color }), index.h("ezp-select", { label: i18next.t('printer_selection.orientation'), placeholder: i18next.t('printer_selection.select_orientation'), toggleFlow: "horizontal", options: this.printerConfig.OrientationsSupported.map((orientation, index) => ({
        id: this.printerConfig.OrientationsSupportedId[index],
        title: i18next.t(`printer_selection.orientation_${orientation}`),
        meta: '',
        type: 'orientation',
      })), preSelected: this.previouslySelectedProperties.orientation }), index.h("ezp-select", { label: i18next.t('printer_selection.size'), placeholder: i18next.t('printer_selection.select_size'), toggleFlow: "horizontal", optionFlow: "horizontal", options: this.printerConfig.PaperFormats.map((format) => ({
        id: format.Id,
        title: i18next.t(`printer_selection.format_${format.Name}`),
        meta: `${format.XRes} x ${format.YRes}`,
        type: 'format',
      })), preSelected: this.previouslySelectedProperties.paper }), index.h("ezp-select", { label: i18next.t('printer_selection.quality'), toggleFlow: "horizontal", options: this.qualityOptions.map((option) => ({
        id: option.id,
        title: option.title,
        meta: '',
        type: 'quality',
        ...
        ? 'Normal'
        : this.previouslySelectedProperties.resolution }), index.h("ezp-select", { label: i18next.t('printer_selection.duplex'), toggleFlow: "horizontal", options: this.duplexOptions.map((option) => ({
        id: option.id,
        title: option.title,
        meta: '',
        type: 'duplex',
        ...
        ? 'None'
        : this.previouslySelectedProperties.duplexmode }), index.h("ezp-stepper", { label: "Copies", max: 10 }))), index.h("div", { id: "footer" }, index.h("ezp-text-button", { type: "button", level: "secondary", onClick: this.handleCancel, label: i18next.t('button_actions.cancel') }), index.h("ezp-text-button", { type: "button", onClick: this.handlePrint, label: i18next.t('button_actions.print') })), index.h("ezp-user-menu", { open: this.userMenuOpen, name: this.userName }))));
  }
};
...
const EzpPrinting = class {
   ...
   */
  render() {
    return (index.h(index.Host, null, this.authOpen ? (index.h("ezp-auth", { clientID: this.clientid, redirectURI: this.redirecturi, hidelogin: this.hidelogin })) : this.printOpen ? (index.h("ezp-printer-selection", { clientID: this.clientid, redirectURI: this.redirecturi, filename: this.filename, fileurl: this.fileurl, filetype: this.filetype })) : this.custom ? (index.h("slot", null)) : (index.h("ezp-icon-button", { id: "print-trigger", icon: "printer", slot: "trigger", type: "button", onClick: () => this.open() }))));
  }
};
...
const EzpProgress = class {
   ...
   */
  render() {
    return (index.h(index.Host, null, index.h("div", { id: "box" }, index.h("svg", { id: "indicator", viewBox: "0 0 44 44", xmlns: "http://www.w3.org/2000/svg" }, index.h("circle", { id: "track", cx: "22", cy: "22", r: "16" }), index.h("circle", { id: "value", cx: "22", cy: "22", r: "16" })), index.h("ezp-label", { id: "status", level: "tertiary", weight: "strong", text: this.status }))));
  }
};
EzpProgress.style = ezpProgressCss;
...
const EzpSelect = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.selectToggle = index.createEvent(this, "selectToggle", 7);
    this.selectSelection = index.createEvent(this, "selectSelection", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { class: hostClasses.join(' ') }, index.h("div", { id: "wrap" }, index.h("div", { id: "toggle", onClick: () => this.toggle() }, this.icon ? index.h("ezp-icon", { id: "icon", name: this.icon }) : null, index.h("ezp-label", { id: "label", noWrap: true, level: labelLevel, text: this.label }), index.h("ezp-label", { id: "value", ellipsis: true, text: this.selected.title !== '' ? this.selected.title : this.placeholder }), index.h("ezp-icon", { id: "accessory", name: "expand" })), index.h("div", { id: "list", ref: (element) => (this.list = element) }, this.options.map((option) => (index.h("div", { class: `option ${option.id === this.selected.id ? 'is-selected' : ''} ${option.meta !== '' ? 'has-meta' : ''} `, onClick: () => this.select(option.id) }, index.h("ezp-icon", { name: "checkmark", class: "indicator" }), index.h("div", { class: "details" }, index.h("ezp-label", { class: "title", ellipsis: true, text: option.title }), option.meta !== '' ? (index.h("ezp-label", { level: "tertiary", class: "meta", text: option.meta })) : null))))))));
  }
  get component() { return index.getElement(this); }
...
const EzpStepper = class {
   ...
   */
  render() {
    return (index.h(index.Host, null, index.h("ezp-label", { noWrap: true, id: "label", text: this.label }), index.h("input", { id: "input", type: "number", ref: (input) => (this.input = input), min: this.min.toString(), max: this.max.toString(), value: this.value.toString(), onInput: this.handleInput }), index.h("div", { class: "buttons" }, index.h("button", { class: "button", disabled: !this.canDecrease, onClick: this.handleDecrease }, index.h("ezp-icon", { name: "minus" })), index.h("button", { class: "button", disabled: !this.canIncrease, onClick: this.handleIncrease }, index.h("ezp-icon", { name: "plus" })))));
  }
  static get watchers() { return {
    "value": ["watchValue"]
  }; }
...
const EzpTextButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: `${this.level}` }, index.h(TagType, Object.assign({ class: "button" }, attributes), index.h("ezp-label", { weight: "heavy", text: this.label }))));
  }
};
...
const EzpUserMenu = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.userMenuClosure = index.createEvent(this, "userMenuClosure", 7);
    this.logoutEmitter = index.createEvent(this, "logoutEmitter", 7);
    this.backdrop = document.createElement('ezp-backdrop');
    this.links = [
      {
   ...
   */
  render() {
    return (index.h(index.Host, { class: this.open ? 'is-open' : '' }, index.h("div", { id: "header" }, index.h("ezp-label", { ellipsis: true, id: "name", weight: "strong", text: this.name }), index.h("ezp-icon-button", { id: "close", level: "quaternary", icon: "cross", onClick: this.handleClose })), index.h("div", { id: "links" }, this.links.map((link) => (index.h("a", { class: "link", href: link.href, target: "_blank", rel: "noopener noreferrer" }, index.h("ezp-icon", { class: "link__icon", name: link.icon }), index.h("ezp-label", { text: link.title })))), index.h("a", { class: "link", onClick: this.logOut }, index.h("ezp-icon", { class: "link__icon", name: "off" }), index.h("ezp-label", { text: "Logout" })))));
  }
  get component() { return index.getElement(this); }
  static get watchers() { return {
    "open": ["watchOpen"]
...
exports.ezp_auth = EzpAuth;
exports.ezp_backdrop = EzpBackdrop;
exports.ezp_icon = EzpIcon;
exports.ezp_icon_button = EzpIconButton;
exports.ezp_label = EzpLabel;
exports.ezp_printer_selection = EzpPrinterSelection;
exports.ezp_printing = EzpPrinting;
exports.ezp_progress = EzpProgress;
exports.ezp_select = EzpSelect;
exports.ezp_stepper = EzpStepper;
exports.ezp_text_button = EzpTextButton;
exports.ezp_user_menu = EzpUserMenu;
