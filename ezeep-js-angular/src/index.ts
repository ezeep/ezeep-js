...
export declare interface CapDisplay extends Components.CapDisplay {}
@ProxyCmp({
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'tag', 'trailing', 'weight']
})
@Component({
...
export declare interface CapHeading extends Components.CapHeading {}
@ProxyCmp({
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'tag', 'trailing', 'weight']
})
@Component({
  selector: 'cap-heading',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'tag', 'trailing', 'weight']
})
...
export declare interface CapLabel extends Components.CapLabel {}
@ProxyCmp({
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'trailing', 'weight']
})
@Component({
  selector: 'cap-label',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
export declare interface CapParagraph extends Components.CapParagraph {}
@ProxyCmp({
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'trailing', 'weight']
})
@Component({
  selector: 'cap-paragraph',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['clip', 'family', 'leading', 'level', 'size', 'trailing', 'weight']
})
...
@ProxyCmp({
  inputs: ['icon', 'label', 'optionFlow', 'options', 'placeholder', 'previouslySelected', 'toggleFlow']
})
@Component({
  selector: 'ezp-select',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@ProxyCmp({
  inputs: ['blank', 'disabled', 'href', 'level', 'type']
})
@Component({
